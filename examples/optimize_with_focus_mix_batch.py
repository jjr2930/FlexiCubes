...
if __name__ == "__main__":
    ...
    mesh_np.export(os.path.join(FLAGS.out_dir, f'gird_res {FLAGS.voxel_grid_res} | iter {FLAGS.iter} | mc {mixing_count}  | lr {FLAGS.learning_rate} | train_res {FLAGS.train_res}.obj'))
