...
if __name__ == "__main__":
    ...
    mixing_count = FLAGS.mixing_count
    # ==============================================================================================
    #  parse focus data
    # ==============================================================================================
    ...
    mesh_np.export(os.path.join(FLAGS.out_dir, f'gird_res {FLAGS.voxel_grid_res} | iter {FLAGS.iter} | fsi {FLAGS.focus_start_iteration}  | lr {FLAGS.learning_rate} | train_res {FLAGS.train_res}.obj'))
